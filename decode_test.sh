#!/bin/bash
#SBATCH -J hard_s --partition=gpu --gres=gpu:1 --time=2-00:00:00 --output=test.decode.cache --error=test.decode.err_cache
#SBATCH --mem=10GB
...
for size in ${beam_size[@]}; do
    ...
    python NP2P_beam_decoder.py --model_prefix ${model_prefix} \
            ...
            --out_path decode_results/test/hard_cache${cache_size}_beam${size}.amr \
            --mode beam_decode \
            --decode True \
