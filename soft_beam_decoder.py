...
if __name__ == '__main__':
    ...
    if use_dep:
        testset = soft_NP2P_data_stream.read_Testset(in_path, ulfdep=args.ulf)
    elif FLAGS.infile_format == 'fof':
        testset = soft_NP2P_data_stream.read_generation_datasets_from_fof(in_path, isLower=FLAGS.isLower, ulfdep=args.ulf)
    else:
        testset = soft_NP2P_data_stream.read_all_GenerationDatasets(in_path, isLower=FLAGS.isLower, ulfdep=args.ulf)
